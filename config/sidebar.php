...
return [
    ...
    [
        ...
        'children' => [
            ...
            [
                ...
                'slug' => 'my_disciplinary_actions',
                'route' => '',
                'icon' => 'my_disciplinary_actions',
                'permission_name' => 'sidebar_view_my_disciplinary_actions',
                'order' => 6,
                'is_active' => 1,
            ],
            [
    ...
    [
        ...
        'children' => [
            ...
            [
                'name' => ['ar' => 'تسجيل الحضور والانصراف', 'en' => 'Attendance Log'],
                'slug' => 'attendance_log',
                'route' => 'system.attendance-departure.index',
                'icon' => 'attendance_log',
                'permission_name' => 'sidebar_view_attendance_log',
                'order' => 2,
                'is_active' => 1,
            ],
            [
                ...
                'route' => 'system.disciplinary-actions.index',
